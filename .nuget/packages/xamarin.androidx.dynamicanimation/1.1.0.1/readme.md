This package provides .NET for Android and MAUI bindings for the Java library `androidx.dynamicanimation:dynamicanimation`.
...
| **Project URL** | https://developer.android.com/jetpack/androidx/releases/dynamicanimation#1.1.0 |
