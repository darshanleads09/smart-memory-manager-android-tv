This package provides .NET for Android and MAUI bindings for the Java library `androidx.lifecycle:lifecycle-runtime-ktx`.
...
| **Artifact ID** | lifecycle-runtime-ktx |
| **Version** | 2.8.7 |
